...
def specific_mining():
    ...
    historico_na_universidade_file = open(f'./results/{OUTPUT}/specific/primary/historicosUniversidade.csv', 'w', encoding='utf-8', newline='')
    ...
    qte_de_formacoes_na_universidade_file = open(f'./results/{OUTPUT}/specific/primary/pontuacaoIndividual.csv', 'w', encoding='utf-8', newline='')
    ...
    conexoes_entre_universidades_file = open(f'./results/{OUTPUT}/specific/primary/conexoesUniversidade.csv', 'w', encoding='utf-8', newline='')
    ...
    areas_de_atuacao_file = open(f'./results/{OUTPUT}/specific/primary/areasAtuacao.csv', 'w', encoding='utf-8', newline='')
    ...
    for curriculo in CURRICULOS:
        try:
            ...
            qte_parcial_de_formacoes = pd.Series(index=['CURSO-TECNICO-PROFISSIONALIZANTE',
                                            'GRADUACAO',
                                            'MESTRADO',
                                            'DOUTORADO'], dtype='int64')
    ...
    pd.DataFrame(qte_total_de_formacoes).T.to_csv(f'./results/{OUTPUT}/specific/quantitative/contFormacoesTotal.csv', sep=',', encoding='utf-8', index=False, mode='w')
