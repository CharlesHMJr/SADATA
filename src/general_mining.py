...
def general_mining():
    ...
    areas_de_atuacao_file = open(f'./results/{OUTPUT}/general/primary/areas_de_atuacao.csv', 'w', encoding='utf-8', newline='')
    ...
    pd.DataFrame(qte_total_de_formacoes).T.to_csv(f'./results/{OUTPUT}/general/quantitative/cont_formacoes_total.csv', sep=',', encoding='utf-8', index=False, mode='w')
